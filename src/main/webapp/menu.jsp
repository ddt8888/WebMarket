	...
	<nav class="navbar navbar-expand navbar-dark">
		<div class="container">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item col-md-2"><a class="nav-link" href="#" style="color:black">밀키트</a></li>
				<li class="nav-item col-md-2"><a class="nav-link" href="<c:url value="/BoardListAction.do?pageNum=1"/>" style="color:black">무료나눔</a></li>
				<li class="nav-item col-md-2"><a class="nav-link" href="#" style="color:black">고객센터</a></li>
			</ul>
			<div class="dropdown">
